...
namespace Common.Api.Configurations
{
    public class JwtOptions
    {
        ...
        /// <summary>
        /// Set the timespan the token will be valid for (default is 30 min/1800 seconds)
        /// </summary>
        ...
        /// <summary>
        /// Claim name for the schoolcode in the token
        /// Add a comment to this line
        /// </summary>
        public string CommonClaimName { get; set; }
        public const string ClaimAcessName = "HasAcess";
    }
}